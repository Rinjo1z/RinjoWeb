const { getUser: getUserService, newUser: newUserService, updateUser: updateUserService } = require('../services/user.service');

const getUser = async (req, res) => {
    try {
        const items = await getUserService();
...
const newUser = async (req, res) => {
    try {
        ...
        const existe = await getUserService({ email });
        if (existe) {
